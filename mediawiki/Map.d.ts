declare namespace mw {
    ...
    namespace Map {
        // `ExtensibleMap<V, TX>` is an alternative to `Map<V & Record<string, TX>>`,
        // but unlike the latter ExtensibleMap provides additional overloads
        // to improve selection autocompletion and type checking.
