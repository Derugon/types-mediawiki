 ...
 */
declare function addOnloadHook(fn: () => void): void;
 ...
 */
declare function importScript(title: string): HTMLScriptElement | null;
 ...
 */
declare function importScriptURI(url: string): HTMLScriptElement | null;
 ...
 */
declare function importStylesheet(title: string): HTMLLinkElement;
 ...
 */
declare function importStylesheetURI(url: string, media: string): HTMLLinkElement;
