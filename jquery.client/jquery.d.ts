...
declare namespace JQuery {
    interface Client {
         ...
         */
        test(map: Client.SupportMap, profile?: Client.Profile, exactMatchOnly?: boolean): boolean;
    }
    ...
    namespace Client {
        ...
        type SupportCondition = [ComparisonOperator, string | number];

        type UndirectedSupportMap = Partial<Record<ProfileName, false | null | SupportCondition[]>>;
        type SupportMap = UndirectedSupportMap | Record<"ltr" | "rtl", UndirectedSupportMap>;
